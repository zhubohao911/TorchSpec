...
def _train_impl(
    ...
    _eagle3_id = eagle3_run_id or "eagle3-qwen3-8b"
    ...
    if run_eagle3:
        print(f"  Eagle3 log:         {OUTPUTS_DIR}/{_eagle3_id}.log")
        print(f"  Eagle3 checkpoints: {OUTPUTS_DIR}/{_eagle3_id}/checkpoints/")
    if run_dflash:
...
def main(
    ...
    train_sglang.spawn(
        ...
        resume=resume,
        dflash_run_id=dflash_run_id or None,
        eagle3_run_id=eagle3_run_id or None,
    ).get()
